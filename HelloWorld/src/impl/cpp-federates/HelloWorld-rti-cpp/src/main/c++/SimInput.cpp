...
std::ostream &operator<<( std::ostream &os, const SimInput &entity ) {
	return os << "SimInput("  << "actualLogicalGenerationTime:" << entity.get_actualLogicalGenerationTime() << ", " << "data:" << entity.get_data() << ", " << "federateFilter:" << entity.get_federateFilter() << ", " << "originFed:" << entity.get_originFed() << ", " << "sourceFed:" << entity.get_sourceFed()	<< ")";
}
...
SimInput::ParameterHandleValuePairSetSP SimInput::createDatamemberHandleValuePairSet( RTI::ULong count ) {
