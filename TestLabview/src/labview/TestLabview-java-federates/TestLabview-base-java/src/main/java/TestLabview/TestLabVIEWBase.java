...
public class TestLabVIEWBase extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public TestLabVIEWBase(FederateConfig config) throws Exception {
		super(config);
        ...
        Setpoint.publish_Occupied();
        Setpoint.publish_ZoneTempSP();
        Setpoint.publish(getLRC());
        
        	
        SystemState.publish_TotalPower();
        SystemState.publish(getLRC());
	...
	public Supply create_Supply() {
	   Supply interaction = new Supply();
