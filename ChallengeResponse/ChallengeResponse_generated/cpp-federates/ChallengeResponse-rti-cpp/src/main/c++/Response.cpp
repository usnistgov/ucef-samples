...
void Response::init( boost::shared_ptr< RTI::RTIambassador > rti ) {
	...
	getClassNameHandleMap().insert(  std::make_pair( "Response", get_handle() )  );
	getClassHandleNameMap().insert(  std::make_pair( get_handle(), "Response" )  );
...
bool Response::static_init( void ) {
	static bool isInitialized = false;
	if ( isInitialized ) {
		return true;
	}
	...
	getClassNameSet().insert( "Response" );
	
	getClassNameFactoryMap().insert(  std::make_pair( "Response", &Response::factory )  );
	getClassNamePublishMap().insert(   std::make_pair(  "Response", (PubsubFunctionPtr)( &Response::publish )  )   );
	getClassNameUnpublishMap().insert(   std::make_pair(  "Response", (PubsubFunctionPtr)( &Response::unpublish )  )   );
	getClassNameSubscribeMap().insert(   std::make_pair(  "Response", (PubsubFunctionPtr)( &Response::subscribe )  )   );
	getClassNameUnsubscribeMap().insert(   std::make_pair(  "Response", (PubsubFunctionPtr)( &Response::unsubscribe )  )   );

	getDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "Response", &getDatamemberNames() )  );
	getAllDatamemberClassNameVectorPtrMap().insert(  std::make_pair( "Response", &getAllDatamemberNames() )  );
