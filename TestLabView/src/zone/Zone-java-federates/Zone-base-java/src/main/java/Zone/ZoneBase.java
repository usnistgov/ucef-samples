...
public class ZoneBase extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public ZoneBase(FederateConfig config) throws Exception {
		super(config);
        ...
        ZoneState.publish_CoolingOverride();
        ZoneState.publish_IATemperature();
        ZoneState.publish_PowerTotal();
        ZoneState.publish_ZoneName();
        ZoneState.publish(getLRC());
