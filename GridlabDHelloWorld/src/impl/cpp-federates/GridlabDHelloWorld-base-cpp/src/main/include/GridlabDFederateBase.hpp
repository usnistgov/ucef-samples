...
protected:
	void init() {
        ...
        InteractionRoot::publish( getRTI() );
        GridlabDOutput::publish( getRTI() );
        C2WInteractionRoot::publish( getRTI() );
        ...
        C2WInteractionRoot::subscribe( getRTI() );
		_subscribedInteractionFilter.setFedFilters( C2WInteractionRoot::get_handle(), SubscribedInteractionFilter::ORIGIN_FILTER_DISABLED, SubscribedInteractionFilter::SOURCE_FILTER_DISABLED );  
        ...
        InteractionRoot::subscribe( getRTI() );
		_subscribedInteractionFilter.setFedFilters( InteractionRoot::get_handle(), SubscribedInteractionFilter::ORIGIN_FILTER_DISABLED, SubscribedInteractionFilter::SOURCE_FILTER_DISABLED );  
...
public:	
	// constructor	
	GridlabDFederateBase(FederateConfig *fedconfig): Super(fedconfig) { init(); }
