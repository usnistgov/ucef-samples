...
public class WeatherBase extends SynchronizedFederate {
    ...
    // constructor
    public WeatherBase( String federation_id, String federate_id ) throws Exception {
       ...
       // constructor
    public WeatherBase(  String[] federationInfo ) throws Exception {
