...
public class Response extends ChallengeInteraction {
	...
	/**
	* Default constructor -- creates an instance of the Response interaction
	...
	*/
	...
	/**
	* Returns the handle (RTI assigned) of the Response interaction class.
	...
	*/
	...
	/**
	* Returns the fully-qualified (dot-delimited) name of the Response
	* interaction class.
	* Note: As this is a static method, it is NOT polymorphic, and so, if called on
	...
	* class name) of the Response interaction class.
	*/
	public static String get_simple_class_name() { return "Response"; }
	...
	* (that is, the Response interaction class).
	*
	* @param handle handle to compare to the value of the handle (RTI assigned) of
	* this class (the Response interaction class).
	...
	*/
	...
	protected Response( ReceivedInteraction datamemberMap, boolean initFlag ) {
		super( datamemberMap, false );
		if ( initFlag ) setParameters( datamemberMap );
	}
	
	protected Response( ReceivedInteraction datamemberMap, LogicalTime logicalTime, boolean initFlag ) {
	...
	/**
	* Creates an instance of the Response interaction class, using
	* "datamemberMap" to initialize its parameter values.
	* "datamemberMap" is usually acquired as an argument to an RTI federate
	* callback method, such as "receiveInteraction".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new Response interaction class instance
	*/
	public Response( ReceivedInteraction datamemberMap ) {
		this( datamemberMap, true );
	}
	
	/**
	* Like {@link #Response( ReceivedInteraction datamemberMap )}, except this
	* new Response interaction class instance is given a timestamp of
	* "logicalTime".
	*
	* @param datamemberMap data structure containing initial values for the
	* parameters of this new Response interaction class instance
	* @param logicalTime timestamp for this new Response interaction class
	* instance
	*/
	public Response( ReceivedInteraction datamemberMap, LogicalTime logicalTime ) {
		this( datamemberMap, logicalTime, true );
	}

	/**
	* Creates a new Response interaction class instance that is a duplicate
	* of the instance referred to by Response_var.
	*
	* @param Response_var Response interaction class instance of which
	* this newly created Response interaction class instance will be a
	* duplicate
	*/
	public Response( Response Response_var ) {
		super( Response_var );
