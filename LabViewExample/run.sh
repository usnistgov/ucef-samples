...
cd $root_directory/src/LabViewExample_deployment
...
cd $root_directory/src/WeatherProject_generated/WeatherProject-java-federates/WeatherProject-impl-java/Weather/target
cp -r ../conf/ .
cp ../RTI.rid ./RTI.rid
cp ./conf/tmy3.csv ./tmy3.csv
xterm -fg red -bg black -l -lf $logs_directory/weather-${timestamp}.log -T "Weather" -geometry 140x40+150+150 \
    -e "java -Dlog4j.configurationFile=conf/log4j2.xml -Djava.net.preferIPv4Stack=true -jar Weather-0.1.0-SNAPSHOT.jar -configFile=conf/WeatherConfig.json" &
waitUntilJoined Weather 1

cd $root_directory/src/MetronomeProject_generated/MetronomeProject-java-federates/MetronomeProject-impl-java/Metronome/target
cp -r ../conf/ .
cp ../RTI.rid ./RTI.rid
xterm -fg magenta -bg black -l -lf $logs_directory/metronome-${timestamp}.log -T "Metronome" -geometry 140x40+200+200 \
    -e "java -Dlog4j.configurationFile=conf/log4j2.xml -Djava.net.preferIPv4Stack=true -jar Metronome-0.1.0-SNAPSHOT.jar -configFile=conf/MetronomeConfig.json" &
waitUntilJoined Metronome 1

cd $root_directory/src/ZoneProject_generated/ZoneProject-java-federates/ZoneProject-impl-java/Zone/target
cp -r ../conf/ .
cp ../RTI.rid ./RTI.rid
xterm -fg cyan -bg black -l -lf $logs_directory/zone1-${timestamp}.log -T "Zone 1" -geometry 140x40+250+250 \
    -e "java -Dlog4j.configurationFile=conf/log4j2.xml -Djava.net.preferIPv4Stack=true -jar Zone-0.1.0-SNAPSHOT.jar -configFile=conf/ZoneConfig1.json -name=Zone1" &
waitUntilJoined Zone 1
xterm -fg cyan -bg black -l -lf $logs_directory/zone2-${timestamp}.log -T "Zone 2" -geometry 140x40+300+300 \
    -e "java -Dlog4j.configurationFile=conf/log4j2.xml -Djava.net.preferIPv4Stack=true -jar Zone-0.1.0-SNAPSHOT.jar -configFile=conf/ZoneConfig2.json -name=Zone2" &
waitUntilJoined Zone 2

cd $root_directory/src/ControllerProject_generated/ControllerProject-java-federates/ControllerProject-impl-java/Controller/target
cp -r ../conf/ .
cp ../RTI.rid ./RTI.rid
xterm -fg green -bg black -l -lf $logs_directory/controller1-${timestamp}.log -T "Controller 1" -geometry 140x40+350+350 \
    -e "java -Dlog4j.configurationFile=conf/log4j2.xml -Djava.net.preferIPv4Stack=true -jar Controller-0.1.0-SNAPSHOT.jar -configFile=conf/ControllerConfig1.json -name=Controller1" &
...
xterm -fg green -bg black -l -lf $logs_directory/controller2-${timestamp}.log -T "Controller 2" -geometry 140x40+400+400 \
    -e "java -Dlog4j.configurationFile=conf/log4j2.xml -Djava.net.preferIPv4Stack=true -jar Controller-0.1.0-SNAPSHOT.jar -configFile=conf/ControllerConfig2.json -name=Controller2" &
waitUntilJoined Controller 2

cd $root_directory/src/LabViewProject_generated/LabView
xterm -fg yellow -bg black -l -lf $logs_directory/labview-${timestamp}.log -T "LabVIEW" -geometry 140x40+450+450 -e "sh run.sh" &
