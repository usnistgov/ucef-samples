...
public class JavaBaseReceiverBase extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public JavaBaseReceiverBase(FederateConfig config) throws Exception {
		super(config);
        ...
        InteractionBase.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
			InteractionBase.get_handle(), 
        ...
        ObjectBase.subscribe_id();
        ObjectBase.subscribe(getLRC());
        	}
