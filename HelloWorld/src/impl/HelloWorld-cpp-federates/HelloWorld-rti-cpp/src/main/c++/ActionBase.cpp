...
void ActionBase::init( RTI::RTIambassador *rti ) {
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "ActionBase.actualLogicalGenerationTime", get_actualLogicalGenerationTime_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "ActionBase.federateFilter", get_federateFilter_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "ActionBase.originFed", get_originFed_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "ActionBase.sourceFed", get_sourceFed_handle() )  );
