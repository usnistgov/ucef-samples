...
public class UtilityBase extends SynchronizedFederate {
    ...
    // constructor
    public UtilityBase( String federation_id, String federate_id ) throws Exception {
        ...
        ResourcePhysicalState.subscribe( getRTI() );
        _subscribedInteractionFilter.setFedFilters( 
       ...
       // constructor
    public UtilityBase(  String[] federationInfo ) throws Exception {
...
*/
        ...
        if(federationInfo.length  > 2) {
            ...
            SimTime.enableSubscribeLog(
                ...
                "NORMAL", 
                loglevel);
            ResourcePhysicalState.enableSubscribeLog(
