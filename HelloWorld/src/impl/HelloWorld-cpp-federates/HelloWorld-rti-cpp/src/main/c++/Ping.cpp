...
void Ping::init( RTI::RTIambassador *rti ) {
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "Ping.actualLogicalGenerationTime", get_actualLogicalGenerationTime_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "Ping.federateFilter", get_federateFilter_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "Ping.originFed", get_originFed_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "Ping.sourceFed", get_sourceFed_handle() )  );
