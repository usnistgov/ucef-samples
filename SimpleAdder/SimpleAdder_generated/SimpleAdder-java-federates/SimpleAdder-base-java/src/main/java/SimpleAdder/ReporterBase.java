...
public class ReporterBase extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public ReporterBase(FederateConfig config) throws Exception {
		super(config);
        ...
        AdderOutput.subscribe(getLRC());
        _subscribedInteractionFilter.setFedFilters( 
			AdderOutput.get_handle(), 
