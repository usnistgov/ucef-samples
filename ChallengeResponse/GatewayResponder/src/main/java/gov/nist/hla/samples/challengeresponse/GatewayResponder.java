...
public class GatewayResponder implements GatewayCallback {
    ...
    private static final String INTERACTION_CHALLENGE =
            "InteractionRoot.C2WInteractionRoot.InteractionBase.InteractionChallenge";
    private static final String INTERACTION_RESPONSE = "InteractionRoot.C2WInteractionRoot.InteractionBase.Response";
    private static final String OBJECT_CHALLENGE = "ObjectRoot.ObjectBase.ObjectChallenge";
    ...
    private void processChallenge(Map<String, String> challenge) {
        ...
        final String id = challenge.get("id");
        ...
        sendResponse(id, stringValue.substring(beginIndex));
    }
