...
public class Operand extends ObjectRoot {
	...
	*/
	...
	private Attribute< Double > _value =
	...
	*/
	public Object getAttribute( int datamemberHandle ) {
		...
		if ( get_value_handle() == datamemberHandle ) return new Double(get_value());
	...
	protected boolean setAttributeAux( int param_handle, String val ) {
		...
		if ( param_handle == get_value_handle() ) set_value( Double.parseDouble(val) );
