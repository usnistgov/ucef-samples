...
void Response::init( RTI::RTIambassador *rti ) {
	...
	while( isNotInitialized ) {
		try {
			getHandle() = rti->getInteractionClassHandle( "InteractionRoot.C2WInteractionRoot.ParentInteraction.Response" );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "Response.actualLogicalGenerationTime", get_actualLogicalGenerationTime_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "Response.challengeId", get_challengeId_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "Response.federateFilter", get_federateFilter_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "Response.originFed", get_originFed_handle() )  );
	...
	getDatamemberNameHandleMap().insert(  std::make_pair( "Response.sourceFed", get_sourceFed_handle() )  );
...
std::ostream &operator<<( std::ostream &os, const Response &entity ) {
	return os << "Response("
			...
			<< ", " << "substring:" << entity.get_substring()
			<< ")";
}
