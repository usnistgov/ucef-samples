 ...
 * 
 * <!-- end-model-doc -->
 * @see org.ieee.standards.ieee1516._2010._2010Package#getOrderEnumerations()
 * @model extendedMetaData="name='orderEnumerations'"
 * @generated
 */
public enum OrderEnumerations implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	TIME_STAMP(1, "TimeStamp", "TimeStamp");
	 ...
	 * @ordered
	 */
	public static final int TIME_STAMP_VALUE = 1;
	 ...
	 * @generated
	 */
	public static final List<OrderEnumerations> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
