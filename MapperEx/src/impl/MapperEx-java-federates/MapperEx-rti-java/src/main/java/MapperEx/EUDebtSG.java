...
public class EUDebtSG extends C2WInteractionRoot {
	...
	private static final Logger logger = LogManager.getLogger(EUDebtSG.class);
	...
	*/
	...
	private static int _debtBillionUSDs_handle;
	
	
	/**
	* Returns the handle (RTI assigned) of the "debtBillionUSDs" parameter of
	* its containing interaction class.
	*
	* @return the handle (RTI assigned) of the "debtBillionUSDs" parameter
	*/
	public static int get_debtBillionUSDs_handle() { return _debtBillionUSDs_handle; }
	...
	*/
	...
	static {
		...
		_datamemberNames.add("debtBillionUSDs");
		...
		_allDatamemberNames.add("debtBillionUSDs");
		_allDatamemberNames.add("federateFilter");
		_allDatamemberNames.add("originFed");
		_allDatamemberNames.add("sourceFed");
		
		
		_datamemberTypeMap.put("debtBillionUSDs", "int");
	...
	protected static void init(RTIambassador rti) {
		...
		while(isNotInitialized) {
			try {
				...
				_debtBillionUSDs_handle = rti.getParameterHandle("debtBillionUSDs", get_handle());
				isNotInitialized = false;
			} catch (FederateNotExecutionMember f) {
				logger.error("{} Federate Not Execution Member", initErrorMessage);
				logger.error(f);
		...
		_datamemberNameHandleMap.put("InteractionRoot.C2WInteractionRoot.EUDebtSG,debtBillionUSDs", get_debtBillionUSDs_handle());
			
			
		_datamemberHandleNameMap.put(get_debtBillionUSDs_handle(), "debtBillionUSDs");
	...
	*/
	...
	public String toString() {
		return "EUDebtSG("
			...
			+ "debtBillionUSDs:" + get_debtBillionUSDs()
			+ ")";
	}
	...
	private int _debtBillionUSDs = 0;

	
	
	/**
	* Set the value of the "debtBillionUSDs" parameter to "value" for this parameter.
	*
	* @param value the new value for the "debtBillionUSDs" parameter
	*/
	public void set_debtBillionUSDs( int value ) { _debtBillionUSDs = value; }
	
	/**
	* Returns the value of the "debtBillionUSDs" parameter of this interaction.
	*
	* @return the value of the "debtBillionUSDs" parameter
	*/
	public int get_debtBillionUSDs() { return _debtBillionUSDs; }
	...
	*/
	public EUDebtSG( EUDebtSG EUDebtSG_var ) {
		...
		set_debtBillionUSDs( EUDebtSG_var.get_debtBillionUSDs() );
	}
	...
	*/
	public Object getParameter( String datamemberName ) {
		...
		if (  "debtBillionUSDs".equals( datamemberName )  ) return new Integer(get_debtBillionUSDs());
	...
	*/
	public Object getParameter( int datamemberHandle ) {
		...
		if ( get_debtBillionUSDs_handle() == datamemberHandle ) return new Integer(get_debtBillionUSDs());
	...
	protected boolean setParameterAux( int param_handle, String val ) {
		...
		if ( param_handle == get_debtBillionUSDs_handle() ) set_debtBillionUSDs( Integer.parseInt(val) );
	...
	protected boolean setParameterAux( String datamemberName, String val ) {
		...
		if (  "debtBillionUSDs".equals( datamemberName )  ) set_debtBillionUSDs( Integer.parseInt(val) );	
	...
	protected boolean setParameterAux( String datamemberName, Object val ) {
		...
		if (  "debtBillionUSDs".equals( datamemberName )  ) set_debtBillionUSDs( (Integer)val );		
		else retval = super.setParameterAux( datamemberName, val );
	...
	protected SuppliedParameters createSuppliedDatamembers() {
		SuppliedParameters datamembers = super.createSuppliedDatamembers();
			...
			datamembers.add( get_debtBillionUSDs_handle(), Integer.toString(get_debtBillionUSDs()).getBytes() );
	...
	public void copyFrom( Object object ) {
		...
		if ( object instanceof EUDebtSG ) {
			EUDebtSG data = (EUDebtSG)object;
				...
				_debtBillionUSDs = data._debtBillionUSDs;
