#ifndef _CppResponderBase_
#define _CppResponderBase_
...
class CppResponderBase : public SynchronizedFederate {
...
public:	
	// constructor	
	CppResponderBase(FederateConfig *fedconfig): Super(fedconfig) { init(); }



	
	
	ResponseSP create_Response( void ) {
	   ResponseSP interactionSP = Response::create();
