...
cd $root_directory/SimpleAdder_deployment
...
cd $root_directory/SimpleAdder_deployment
xterm -fg yellow -bg black -l -lf $logs_directory/input-source-${timestamp}.log -T "Input Source" -geometry 140x40+180+60 -e "mvn exec:java -P InputSource,ExecJava" &
waitUntilJoined InputSource 1

cd $root_directory/SimpleAdder_deployment
xterm -fg green -bg black -l -lf $logs_directory/adder-${timestamp}.log -T "Adder" -geometry 140x40+360+120 -e "mvn exec:java -P Adder,ExecJava" &
waitUntilJoined Adder 1

cd $root_directory/SimpleAdder_deployment
xterm -fg cyan -bg black -l -lf $logs_directory/reporter-${timestamp}.log -T "Reporter" -geometry 140x40+540+180 -e "mvn exec:java -P Reporter,ExecJava" &
