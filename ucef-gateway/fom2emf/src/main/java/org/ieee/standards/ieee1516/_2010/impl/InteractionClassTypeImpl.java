 ...
 * </p>
 * <ul>
 *   <li>{@link org.ieee.standards.ieee1516._2010.impl.InteractionClassTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.ieee.standards.ieee1516._2010.impl.InteractionClassTypeImpl#getSharing <em>Sharing</em>}</li>
 *   <li>{@link org.ieee.standards.ieee1516._2010.impl.InteractionClassTypeImpl#getDimensions <em>Dimensions</em>}</li>
 *   <li>{@link org.ieee.standards.ieee1516._2010.impl.InteractionClassTypeImpl#getTransportation <em>Transportation</em>}</li>
 *   <li>{@link org.ieee.standards.ieee1516._2010.impl.InteractionClassTypeImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link org.ieee.standards.ieee1516._2010.impl.InteractionClassTypeImpl#getSemantics <em>Semantics</em>}</li>
 *   <li>{@link org.ieee.standards.ieee1516._2010.impl.InteractionClassTypeImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link org.ieee.standards.ieee1516._2010.impl.InteractionClassTypeImpl#getInteractionClass <em>Interaction Class</em>}</li>
 *   <li>{@link org.ieee.standards.ieee1516._2010.impl.InteractionClassTypeImpl#getAny <em>Any</em>}</li>
 *   <li>{@link org.ieee.standards.ieee1516._2010.impl.InteractionClassTypeImpl#getIdtag <em>Idtag</em>}</li>
 *   <li>{@link org.ieee.standards.ieee1516._2010.impl.InteractionClassTypeImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link org.ieee.standards.ieee1516._2010.impl.InteractionClassTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InteractionClassTypeImpl extends MinimalEObjectImpl.Container implements InteractionClassType {
	 ...
	 * @ordered
	 */
	protected EList<ParameterType1> parameter;
	 ...
	 * @ordered
	 */
	protected EList<InteractionClassType1> interactionClass;
	 ...
	 * @generated
	 */
	public EList<ParameterType1> getParameter() {
		if (parameter == null) {
			parameter = new EObjectContainmentEList<ParameterType1>(ParameterType1.class, this, _2010Package.INTERACTION_CLASS_TYPE__PARAMETER);
		}
		return parameter;
	}
	 ...
	 * @generated
	 */
	public EList<InteractionClassType1> getInteractionClass() {
		if (interactionClass == null) {
			interactionClass = new EObjectContainmentEList<InteractionClassType1>(InteractionClassType1.class, this, _2010Package.INTERACTION_CLASS_TYPE__INTERACTION_CLASS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case _2010Package.INTERACTION_CLASS_TYPE__PARAMETER:
				getParameter().clear();
				getParameter().addAll((Collection<? extends ParameterType1>)newValue);
				return;
			case _2010Package.INTERACTION_CLASS_TYPE__INTERACTION_CLASS:
				getInteractionClass().clear();
				getInteractionClass().addAll((Collection<? extends InteractionClassType1>)newValue);
				return;
			case _2010Package.INTERACTION_CLASS_TYPE__ANY:
