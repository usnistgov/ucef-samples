...
public class InputSourceBase extends SynchronizedFederate {

	private SubscribedInteractionFilter _subscribedInteractionFilter = new SubscribedInteractionFilter();
	
	// constructor
	public InputSourceBase(FederateConfig config) throws Exception {
		super(config);
        ...
        Operand.publish_value();
        Operand.publish(getLRC());
                	}
