...
std::ostream &operator<<( std::ostream &os, const PingCount &entity ) {
	return os << "PingCount("
			 << "RunningCount:" << entity.get_RunningCount()
			<< ", " << "SinkName:" << entity.get_SinkName()
			<< ")";
}

PingCount::AttributeHandleValuePairSetSP PingCount::createDatamemberHandleValuePairSet( bool force ) {
	AttributeHandleValuePairSetSP datamembers = AttributeHandleValuePairSetSP(RTI::AttributeSetFactory::create(2));
	std::string stringConversion;
	bool isPublished;

	isPublished = (m_publishedAttributeNames.find("RunningCount") != m_publishedAttributeNames.end());
	...
	isPublished = (m_publishedAttributeNames.find("SinkName") != m_publishedAttributeNames.end());
...
boost::unordered_set< std::string > PingCount::m_publishedAttributeNames;
