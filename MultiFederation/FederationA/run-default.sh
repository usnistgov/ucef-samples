...
cd $root_directory
xterm -fg white -bg black -l -lf $logs_directory/RandGenerator-${timestamp}.log -T "RandGenerator" -geometry 140x40+60+90 -e "mvn exec:java -P ExecJava,RandGenerator" &
waitUntilJoined RandGenerator 1
