...
public class GridlabDControl extends C2WInteractionRoot {
	...
	private static final Logger logger = LogManager.getLogger(GridlabDControl.class);
	...
	*/
	public Object getParameter( String datamemberName ) {
		...
		if (  "IsControl".equals( datamemberName )  ) return new Boolean(get_IsControl());
		...
		else if (  "Period".equals( datamemberName )  ) return new Double(get_Period());
	...
	*/
	public Object getParameter( int datamemberHandle ) {
		...
		if ( get_IsControl_handle() == datamemberHandle ) return new Boolean(get_IsControl());
		...
		else if ( get_Period_handle() == datamemberHandle ) return new Double(get_Period());
	...
	protected boolean setParameterAux( int param_handle, String val ) {
		...
		if ( param_handle == get_IsControl_handle() ) set_IsControl( Boolean.parseBoolean(val) );
		...
		else if ( param_handle == get_Period_handle() ) set_Period( Double.parseDouble(val) );
	...
	protected boolean setParameterAux( String datamemberName, String val ) {
		...
		if (  "IsControl".equals( datamemberName )  ) set_IsControl( Boolean.parseBoolean(val) );
		...
		else if (  "Period".equals( datamemberName )  ) set_Period( Double.parseDouble(val) );
	...
	protected boolean setParameterAux( String datamemberName, Object val ) {
		...
		if (  "IsControl".equals( datamemberName )  ) set_IsControl( (Boolean)val );
		...
		else if (  "Period".equals( datamemberName )  ) set_Period( (Double)val );
